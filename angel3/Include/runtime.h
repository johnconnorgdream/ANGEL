...
#define IS_PRINTED (0x01)

#define IS_DECED (0x02)
//这是针对可达性分析的标志位，注意这个标志位在进行recovery之后就会还原，在gc过程中不会与IS_DECED冲突
//因为在gc过程中只要遇到IS_FLAGED就不会被GC，自然就用不到
#define IS_FLAGED (0x03)

//暂时标记，做循环应用检测
#define LOOP_CHECK_FLAG (0x04)

//标记是否是循环引用
#define IS_LOOPED (0x05)


#define ISFLAGED(o) ((o->extra_flag & 0x0f) == IS_FLAGED)
#define ISDECED(o) ((o->extra_flag & 0x0f) == IS_DECED)
#define ISPRINTED(o) ((((object)o)->extra_flag & 0x0f) == IS_PRINTED)
#define ISCHECKING(o) ((((object)o)->extra_flag & 0x0f) == LOOP_CHECK_FLAG)
#define ISLOOPED(o) ((((object)o)->extra_flag & 0x0f) == IS_LOOPED)
