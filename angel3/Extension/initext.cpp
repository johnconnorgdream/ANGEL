...
void initexttype()
{
	file_type = (ext_type)angel_sys_calloc(1,sizeof(ext_typenode));
	socket_type = (ext_type)angel_sys_calloc(1,sizeof(ext_typenode));
	thread_type = (ext_type)angel_sys_calloc(1,sizeof(ext_typenode));
	time_type = (ext_type)angel_sys_calloc(1,sizeof(ext_typenode));
	parse_type = (ext_type)angel_sys_calloc(1,sizeof(ext_typenode));
